...
2026-07-07 | Joel+Codex | privacy/security | personal-data trust captured as core product requirement; customer trust and data-release cybersecurity questions added | open: concrete privacy/security plan before public customer positioning
2026-07-10 | Codex | fast-forward-V1 | export, chunks/search, Echo, imports, people, insights, privacy, voice, digest, and rate-limit contracts added on branch only | open: Go limiter compile blocked by missing go binary; provider AI adapters remain local fallback
2026-07-10 | Codex | production hardening | Basic Auth proxy, readiness endpoint, provider-backed Echo hook, Vercel config, Go limiter source, and production checklist added | open: Joel sets hosted DB/auth/domain/provider env values
