...
- Before implementing app behavior, update or confirm `dev-docs/design/idea.md`, `dev-docs/planning/Plan.md`, and `dev-docs/planning/Atomic-Action-Plan.md`. No product implementation should proceed while those three docs are stale.
