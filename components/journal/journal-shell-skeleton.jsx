  ...
  return (
    <div className="flex h-svh w-full overflow-hidden bg-background">
      <div className="hidden w-sidebar-width shrink-0 border-r border-surface-variant/20 bg-surface-container-low px-sm py-md md:block">
        ...
        <Skeleton className="mb-sm h-9 w-full rounded-md bg-surface-container-high/60" />
        <div className="border-t border-outline-variant/10 pt-sm">
          <div className="mb-1 flex h-7 items-center gap-1.5 px-1">
            <Skeleton className="h-3.5 w-3.5 rounded bg-surface-container-high/45" />
            <Skeleton className="h-3.5 w-3.5 rounded bg-surface-container-high/45" />
            <Skeleton className="h-3.5 w-20 rounded bg-surface-container-high/50" />
          </div>
          <div className="flex flex-col gap-1 pl-5">
            ...
            <Skeleton className="h-7 w-3/4 rounded bg-surface-container-high/40" />
          </div>
        </div>
      </div>
